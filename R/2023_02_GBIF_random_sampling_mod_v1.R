...
file <- "/net/home/tkattenborn/data_global_maps/01_gbif_species_2023-06-07.csv"
...
TRY$Species[1:10]
str_extract(TRY$Species[1:10], '[A-Za-z]+ [A-Za-z]+')
...
TRY <- TRY[complete.cases(TRY$speciesName), ]
head(TRY)
...
fwrite(sample_all_cells_7, paste0("/net/home/tkattenborn/data_global_maps/gbif_sample_all_cells_hex7_", paste0(pfts, collapse = "_"), ".csv"), row.names = F)
...
fwrite(sample_all_cells_9, paste0("/net/home/tkattenborn/data_global_maps/gbif_sample_all_cells_hex9_", paste0(pfts, collapse = "_"),".csv"), row.names = F)
...
#       fwrite(sample, paste0("/net/home/tkattenborn/data_global_maps/gbif_samples_5000/gbif_sample_", col_name, "_n", i, "_s", j, ".csv"), row.names = F)
#     }
#   }
# }
# 
...
#       print(length(unique(sample[[col_name]])))
#       fwrite(sample, paste0("/net/home/tkattenborn/data_global_maps/gbif_samples_flex/gbif_sample_", col_name, "_n", i, "_s", j, ".csv"), row.names = F)
#     }
#   }
# }
